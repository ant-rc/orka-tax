...
export interface Lot {
  ...
  city: string;
  status: LotStatus;
  /** Lignes brutes du CSV importé (un bien par ligne). Présent uniquement pour les lots créés par import. */
  biens?: Record<string, string>[];
  /** En-têtes de colonnes du CSV importé, dans l'ordre d'origine. */
  headers?: string[];
}
