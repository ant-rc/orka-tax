    ...
    Tables: {
      biens: {
        Row: {
          ...
          created_at: string
          degrevement_estime: number | null
          depcom: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "biens_batch_id_fkey"
            columns: ["batch_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "biens_lot_id_fkey"
            columns: ["lot_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "biens_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
      ...
      import_batches: {
        ...
        Relationships: [
          {
            foreignKeyName: "import_batches_lot_id_fkey"
            columns: ["lot_id"]
            isOneToOne: false
            referencedRelation: "lots"
            referencedColumns: ["id"]
